...
import Link from "next/link"; // No es necesario el ".js"
...
const Team = () => {
  ...
  useEffect(() => {
    ...
    const fetchTeamData = async () => {
      try {
        const data = await getResearchers(); // Obtén los datos desde Firestore
        console.log("Datos de investigadores obtenidos:", data); // Verifica los datos en consola
        setTeamData(data); // Actualiza el estado con los datos obtenidos
      } catch (error) {
          ...
          <div className="row align-items-center">
            <div className="col-lg-8 col-md-8 col-12">
              <div className="tp-section">
                ...
                <h3 className="tp-section__title mb-75">Conoce a Nuestros Especialistas</h3>
              </div>
            </div>
                ...
                teamData.map((item) => (
                  <SwiperSlide key={item.id}>
                    <div className="swiper-slide">
                      <div className="tp-team mb-50" style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
                        {/* Imagen con tamaño fijo */}
                        <div className="tp-team__thumb fix" style={{ width: '100%', height: '300px', overflow: 'hidden' }}>
                        ...
                        <div className="tp-team__content" style={{ flexGrow: 1 }}>
                          ...
                          <span className="tp-team__position mb-30">
                            {item.experiencia_profesional?.[0]?.institucion || "Institución Desconocida"}
                          </span>
                          {/* Limitar biografía a 4 líneas */}
                          <p>
                          ...
                          <div className="tp-team__social">
                            {/* Si tienen redes sociales, puedes agregarlas aquí */}
