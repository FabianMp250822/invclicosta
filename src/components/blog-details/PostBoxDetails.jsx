...
import BlogSearch from "../blog/blog-search"; // Rutas relativas correctas
import Category from "../blog/category";
import RecentPost from "../blog/recent-post";
import Tags from "../blog/tags";
import CommentForm from "../forms/comment-form"; // Asegúrate de tener este componente
import { getBlogById } from "../services/firebaseService"; // Ruta relativa correcta
        ...
        <div className="row">
          <div className="col-xxl-8 col-xl-8 col-lg-7 col-md-12">
            <div className="postbox__wrapper pr-20">
              ...
              <CommentForm /> {/* Asegúrate de tener este componente */}
            </div>
          </div>
